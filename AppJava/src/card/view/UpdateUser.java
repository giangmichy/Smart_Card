...
public class UpdateUser extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btn_chonanh, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jDate, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btn_chonanhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_chonanhActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                if (selectedFile.length() > 5 * 1024) { // 5 KB = 5 * 1024 bytes
                    JOptionPane.showMessageDialog(this, "File quá lớn. Vui lòng chọn file dưới 5KB.", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
    ...
    private void btn_updateImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateImageActionPerformed
        ...
        if (check == 0x9000) {
            ...
            JOptionPane.showMessageDialog(this, "Cập nhật ảnh không thành công", "ERROR", JOptionPane.ERROR_MESSAGE);
            return;
        }
